...
export default function NameContact({ contacts, onChangeContacts, contactError, onChangeCountries, onChangeCities,
    onChangeActiveEditableCountry, chosenCountries, chosenCities, activeCountry, ...props }) {
